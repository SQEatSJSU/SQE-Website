    ...
    <div className="w-screen min-h-screen overflow-x-hidden bg-[#181818] text-white">
      ...
      <section className="bg-[#181818] flex flex-col items-center text-center pt-24 pb-20">
        <div className="max-w-5xl mx-auto mb-8 px-6">
          ...
          <motion.div
            className="mt-12 bg-zinc-800 rounded-lg p-8 sm:p-12 border border-zinc-700"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <motion.div
            className="mt-8 bg-zinc-800 rounded-lg p-8 sm:p-12 border border-zinc-700"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.4, duration: 0.8, ease: "easeOut" }}
          >
            <h2 className="text-2xl font-semibold text-white mb-4">
              Beginner Software Project
            </h2>
